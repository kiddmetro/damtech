      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white shadow-md rounded-lg p-8">
          ...
          <div className="mt-10 text-sm text-gray-600 text-center space-y-2">
            <p><strong>Email:</strong> <a href="mailto:info@damtechnigeria.com" className="text-blue-700">info@damtechnigeria.com</a></p>
            <p><strong>Phone:</strong> <a href="tel:+2348037023388" className="text-blue-700">+234-803-702-3388</a></p>
            <p><strong>Address:</strong> 117, Liberty Boulevard, British America, Jos, Plateau State, Nigeria</p>
          </div>
        </div>
      </div>
    </section>
